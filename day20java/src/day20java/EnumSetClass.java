...
public class EnumSetClass {
	...
	public static void main(String[] args) {
		...
		System.out.println("------------------------------------------------------");
		System.out.println("Need to work on Monday? " + isWorkingDay(weekDaySet, WeekDay.MONDAY));
		System.out.println("Need to work on Saturday? " + isWorkingDay(weekDaySet, WeekDay.SATURDAY));
		System.out.println("Need to work on Sunday? " + isWorkingDay(weekDaySet, WeekDay.SUNDAY));
	}
